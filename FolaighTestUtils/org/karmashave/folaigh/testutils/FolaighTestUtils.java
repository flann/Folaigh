 ...
 * By Terry Lacy
 */
package org.karmashave.folaigh.testutils;
...
public class FolaighTestUtils {
    private static final String[] encodedKeyStore = {
    ...
    public static InputStream getKeyStoreStream() throws Exception {
        ByteArrayOutputStream output = new ByteArrayOutputStream();
        BASE64Decoder decoder = new BASE64Decoder();
        for (int i = 0; i < encodedKeyStore.length; i++) {
            ByteArrayInputStream input = new ByteArrayInputStream(
                    encodedKeyStore[i].getBytes("UTF-8"));
    ...
    /**
     * Write the test keystore to a file in the user's temp
     * directory.
     * @param baseFilename
     * @return
     */
    public static String writeKeyStoreToFile(String baseFilename) throws Exception {
        InputStream input = getKeyStoreStream();
        String path = System.getProperty("java.io.tmpdir") + File.separator + baseFilename;
